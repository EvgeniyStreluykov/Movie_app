...
import "../styles/btnBuyTicket.css";

const BuyTicketBtn = (props) => {
  const { onClick } = props;

  return (
    <div onClick={onClick} className="btnTicket">
      <div className="btn btn--svg js-animated-button" href="#buyTicket">
        <span className="btn--svg__label">Купить билет</span>
        <svg
